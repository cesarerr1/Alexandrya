...
export default function OutlinedInput(theme) {
  return {
    MuiOutlinedInput: {
      styleOverrides: {
        input: { padding: 'var(--alex-input-padding, 10.5px 14px 10.5px 12px)' },
        notchedOutline: {
        ...
        sizeSmall: { '& .MuiOutlinedInput-input': { padding: 'var(--alex-input-padding-small, 7.5px 8px 7.5px 12px)' } },
